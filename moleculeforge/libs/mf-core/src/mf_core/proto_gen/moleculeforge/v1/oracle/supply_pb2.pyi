...
class AvailabilityRequest(_message.Message):
    __slots__ = ("smiles", "request_id")
    SMILES_FIELD_NUMBER: _ClassVar[int]
    REQUEST_ID_FIELD_NUMBER: _ClassVar[int]
    smiles: str
    request_id: str
    def __init__(self, smiles: _Optional[str] = ..., request_id: _Optional[str] = ...) -> None: ...

class AvailabilityResponse(_message.Message):
    __slots__ = ("smiles", "available", "catalog_id", "catalog_source", "source_timestamp", "price", "currency", "lead_time_days", "evidence_id", "catalog_version", "catalog_checksum")
    SMILES_FIELD_NUMBER: _ClassVar[int]
...
class BatchAvailabilityResponse(_message.Message):
    ...
    request_id: str
    def __init__(self, results: _Optional[_Iterable[_Union[AvailabilityResponse, _Mapping]]] = ..., total_elapsed_ms: _Optional[int] = ..., request_id: _Optional[str] = ...) -> None: ...

class CatalogPriceRequest(_message.Message):
    __slots__ = ("smiles", "catalog_id", "request_id")
    SMILES_FIELD_NUMBER: _ClassVar[int]
    CATALOG_ID_FIELD_NUMBER: _ClassVar[int]
    REQUEST_ID_FIELD_NUMBER: _ClassVar[int]
    smiles: str
    catalog_id: str
    request_id: str
    def __init__(self, smiles: _Optional[str] = ..., catalog_id: _Optional[str] = ..., request_id: _Optional[str] = ...) -> None: ...
