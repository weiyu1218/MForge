...
class CIG(_message.Message):
    __slots__ = ("project_id", "objectives", "edges", "constraints", "created_by")
    ...
    created_by: str
    def __init__(self, project_id: _Optional[str] = ..., objectives: _Optional[_Iterable[_Union[ObjectiveNode, _Mapping]]] = ..., edges: _Optional[_Iterable[_Union[ObjectiveEdge, _Mapping]]] = ..., constraints: _Optional[_Mapping[str, str]] = ..., created_by: _Optional[str] = ...) -> None: ...
